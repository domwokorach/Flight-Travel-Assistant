...
const icons: Partial<Record<TransportOption['kind'], LucideIcon>> = { train: TrainFront, metro: TramFront, bus: Bus, taxi: CarTaxiFront, car: Car }

const STATUS_TEXT_CLASS: Record<TransportServiceStatus, string> = {
...
function openDirections(originQuery: string, destinationQuery: string) {
...
export default function TransportCard({ item, originQuery, destinationQuery }: TransportCardProps) {
