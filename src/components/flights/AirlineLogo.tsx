...
type AirlineLogoSize = keyof typeof sizes
 ...
 */
export default function AirlineLogo({ airlineName, airlineCode, logoUrl, size = 'md', fallback, className }: AirlineLogoProps) {
